    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70xh] mx-auto py-8 bg-black">
      ...
      <div className="col-span-2 px-5 my-auto">
        <h1 className="text-white text-4xl sm:text-5xl lg:text-6xl font-extrabold custom-heading">
          <span className="primary-color pb-5">Soy</span> <br />
          <TypeAnimation
            sequence={["Técnico en Informática", 1000, "Web Developer", 1000, "Estudiante IT", 1000]}
            wrapper="span"
            speed={15}
            repeat={Infinity}
          />
        ...
        <p className="text-white sm:text-lg my-6 lg-:text-xl">
          Estudiante avanzado en sistemas y programador autodidacta.
        </p>
